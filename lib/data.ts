...
export const SERVICES = [
  {
    ...
    items: [
      { name: "Women's Cut & Style", price: 45, description: "Precision cut designed around your face shape and daily routine, finished with a professional round-brush blowout for shape and volume. Includes consultation and personalized style advice." },
      { name: "Men's Clip & Cut", price: 30, description: "Classic and contemporary men's cuts with precision clipper and scissor work. Tapered neckline, clean lines, and a finish that holds between visits." },
      { name: "Children's Cut (under 7)", price: 20, description: "A patient, gentle experience for our youngest guests. Simple shapes and styles in a calm environment — first haircuts always welcome." },
      { name: "Girl's Haircut (7–12)", price: 35, description: "Style-forward cuts for tweens — trims, layers, bob cuts, and blunt shapes. Finished with a light blowout and style advice for home maintenance." },
      { name: "Boy's Haircut (7–12)", price: 25, description: "Precision taper and scissor work for school-age boys. Clean lines, fade options, and age-appropriate styling." },
    ],
  },
  {
    ...
    items: [
      { name: "Blow Out & Style", price: 33, description: "Professional wash, condition, and blow-dry using a round brush for volume, smoothness, and shape. Zero chemical residue, no aftercare restrictions. Our most popular weekday service." },
      { name: "Blow Out with Iron Work", price: 40, description: "Everything in a standard blowout, plus curling iron or flat iron work for added texture, beachy waves, or a sleek pin-straight finish. A $7 upgrade that transforms the result." },
      { name: "Updo & Special Event Styling", price: 75, description: "Elegant updos, French twists, braided styles, chignons, and event-ready looks designed to last all night. Ideal for galas, weddings, proms, and milestone occasions." },
    ],
  },
  {
    category: "Color",
    ...
    items: [
      { name: "Full Color (L'Oréal Majerel/Inoa)", price: 85, description: "All-over color using L'Oréal Majerel for rich pigment or ammonia-free Inoa for scalp-sensitive clients. Includes gray coverage, built-in conditioning agents, and a toning rinse." },
      { name: "Highlights / Balayage", price: 120, description: "Hand-painted balayage and traditional foil highlights for natural-looking dimension, sun-kissed depth, or bold contrast. Technique is selected based on your hair's texture and target result." },
      { name: "Corrective Color", price: 200, description: "Specialized multi-step correction for brassiness, uneven tone, over-processing, or box dye damage. Includes a detailed consultation, strand test, and a tailored treatment plan before any color is applied." },
      { name: "Hair Treatments", price: 50, description: "Deep conditioning, bond-building, and keratin smoothing treatments to restore moisture, elasticity, and shine. Particularly recommended after color, bleach, or chemical services." },
    ],
  },
  {
    category: "Spa Services",
    icon: "sparkles",
    tagline: "Luxury spa treatments without booking two appointments — done right here.",
    items: [
      { name: "Eyelash Extensions", price: 150, description: "Full set of individual lash extensions applied by Sofia. Choose classic (natural), hybrid (mixed), or volume (dramatic) techniques for your ideal lash profile. Fills available every 2–3 weeks." },
      { name: "Facial", price: 80, description: "Customized facial treatment targeting your skin's primary concerns — hydration, brightening, anti-aging, or congestion. Includes double cleanse, exfoliation, mask, and serum application." },
    ],
  },
  {
    category: "Makeup",
    ...
    items: [
      { name: "Makeup Application", price: 75, description: "Full face application by Isabella — foundation matched to your undertone, contouring, eye design, and lip color. Perfect for date nights, professional portraits, events, or simply a night out." },
      { name: "Special Event Makeup", price: 150, description: "Red-carpet-ready glam for galas, birthday celebrations, and milestone occasions. Includes extended wear products, setting spray, and touch-up kit for the event." },
      { name: "Bridal Makeup", price: 200, description: "Wedding day looks designed to photograph beautifully, last through tears and dancing, and feel like you — just the most radiant version. Trial session strongly recommended 4–6 weeks before." },
      { name: "Airbrush Makeup", price: 125, description: "Ultra-smooth, skin-like finish using professional airbrush equipment. Long-wearing, lightweight formula ideal for photography, video, outdoor events, and high-humidity summers." },
      { name: "Makeup Lesson (1 hr)", price: 100, description: "One-on-one coaching session with Isabella. Learn your ideal foundation formula, contouring for your specific bone structure, and receive personalized product recommendations to take home." },
    ],
  },
];
