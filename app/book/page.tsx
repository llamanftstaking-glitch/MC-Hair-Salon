...
const SERVICE_CATEGORIES = [
  {
    ...
    label: "Haircuts",
    services: [
      { name: "Men's Haircut",   price: "$50+"  },
      { name: "Women's Haircut", price: "$120"  },
      { name: "Girl's Haircut",  price: "$55+"  },
      { name: "Boy's Haircut",   price: "$45+"  },
      { name: "Bangs",           price: "$20+"  },
    ],
  },
  {
  ...
  },
  {
    ...
    label: "Color",
    services: [
      { name: "Clear Glossy",                   price: "$35+"            },
      { name: "Single Process",                 price: "$100+"           },
      { name: "Single Process w/ Moroccan Oil", price: "$120"            },
      { name: "Partial Highlights",             price: "$250+"           },
      { name: "Full Highlights",                price: "$350+"           },
      { name: "Face Frame",                     price: "$130"            },
      { name: "Toner",                          price: "$45"             },
      { name: "Partial Balayage",               price: "$250"            },
      { name: "Full Balayage",                  price: "$400"            },
      { name: "Double Process",                 price: "By Consultation" },
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Hair Botox Treatment", price: "$185+"           },
      { name: "Relaxer",              price: "$180+"           },
      { name: "Extensions",           price: "By Consultation" },
  ...
  },
  {
    ...
    label: "Makeup",
    services: [
      { name: "Makeup Application", price: "$125+" },
    ],
  },
];
