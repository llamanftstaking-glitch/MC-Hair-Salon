    ...
    <div className="min-h-screen bg-[var(--mc-bg)] flex flex-col items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm">
        ...
        {result?.earnedBlowout && (
          <div style={{ animation: "fadeUp 0.3s ease-out both" }} className="text-center">
            <div className="w-28 h-28 rounded-full gold-gradient-bg flex items-center justify-center mx-auto mb-6">
